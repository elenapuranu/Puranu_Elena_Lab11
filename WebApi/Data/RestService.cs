...
using Puranu_Elena_Lab11.Models;
using System.Text;
using WebApi.Models;

namespace Puranu_Elena_Lab11.Data
{
    public interface RestService : IRestService
    {
        HttpClient client;
        ...
        public RestService()
        {
            ...
            httpClientHandler.ServerCertificateCustomValidationCallback =(message, cert, chain, errors) => { return true; };client = new HttpClient(httpClientHandler);
        }
